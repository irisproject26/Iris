      ...
      >
        ...
        <View style={styles.whiteBody}>
          ...
          <View style={styles.row}>
            <TouchableOpacity style={styles.outlineButton} onPress={() => navigation.navigate('Information')}>
          ...
          <View style={styles.visitCard}>
            ...
            <View style={styles.visitRight}>
              ...
              <TouchableOpacity style={styles.orangeButton} onPress={() => navigation.navigate('MarcarVisita')}>
